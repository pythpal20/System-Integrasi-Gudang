                        ...
                        <div class="card border-left-danger">
                            <div class="card-body">
                                <div class="form-group row" id="stok1">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" name="qtys" id="stokg75" placeholder="0" disabled="">
                                    </div>
                                </div>
                                <div class="form-group row" id="stok2">
                                    <label for="a50" class="col-sm-3 col-form-label">Stok A-50</label>
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" name="qtys" id="stoka50" placeholder="0" disabled="">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table-condensed table-borderless table-striped" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" name="iGudang50" id="iGudang50">
                                        </td>
                                    </tr>
                                </table>
                            </div>
            ...
            switch (x) {
                ...
                case 2:
                    if (asal == 'a50' && tujuan == 'g75') {
                        hgudang75 = parseInt(istok_g75) + parseInt(fstok_a50);
                        hgudang50 = parseInt(istok_a50) - parseInt(fstok_a50);
                        document.getElementById("gudang50").textContent = istok_a50 + ' - ' + fstok_a50 + ' = ' + hgudang50;
